...
CFLAGS        = $(DEBUG_CFLAG) $(STRIP_CFLAG) $(WARNING_CFLAG) -m32 -c -I$(SOURCE_FOLDER)
...
createiso :
#@cd bin
	@genisoimage -R -b iso/boot/grub/grub1 $(ISOFLAGS) -o bin/$(ISO_NAME) iso
