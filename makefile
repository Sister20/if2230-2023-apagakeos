...
user-shell:
	...
	@$(LIN) -T $(SOURCE_FOLDER)/user/user-linker.ld -melf_i386 \
		user-entry.o user-shell.o $(OUTPUT_FOLDER)/string.o $(OUTPUT_FOLDER)/stdmem.o mkdir.o ls.o -o $(OUTPUT_FOLDER)/shell
	@echo Linking object shell object files and generate flat binary...
	@$(LIN) -T $(SOURCE_FOLDER)/user/user-linker.ld -melf_i386 --oformat=elf32-i386\
		user-entry.o user-shell.o $(OUTPUT_FOLDER)/string.o $(OUTPUT_FOLDER)/stdmem.o mkdir.o ls.o -o $(OUTPUT_FOLDER)/shell_elf
