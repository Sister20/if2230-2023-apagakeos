...
void mv(char* args_val, int (*args_info)[2], int args_count) {
    ...
    char* ext_2;
    if (args_count == 3) {
        if (parse(args_val, args_info, 1, cluster_1, name_1, ext_1) == 1) {
            if (parse(args_val, args_info, 2, cluster_2, name_2, ext_2) == 1) {
                rename(args_val, args_info, args_count, cluster_1, cluster_2);
            } else if (parse(args_val, args_info, 2, cluster_2, name_2, ext_2) == 2) {
